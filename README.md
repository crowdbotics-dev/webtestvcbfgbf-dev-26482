...
## Project Structure
    ...
    ├── webtestvcbfgbf_dev_26482  # Django project configurations
...
1. Clone this repo and `cd webtestvcbfgbf_dev_26482`
...
2. Clone this repo and `cd webtestvcbfgbf_dev_26482`
